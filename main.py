...
headingLabel = Label(headingFrame1, text="Welcome to\nMusic Album Management System", bg="black", fg='white', font=('Courier',15))
...
btn4 = Button(root,text=" Exit ",font='Helvetica 10 bold',bg='black', fg='white', command=root.destroy)
