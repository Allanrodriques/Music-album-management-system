...
class Register:
    def __init__(self, root):
        ...
        # ===Left Image===
        self.left = ImageTk.PhotoImage(file="images/music10.jpeg")
    ...
    def register_data(self):
        if self.txt_fname.get()=="" or self.txt_contact.get()=="" or self.txt_email.get()=="" or self.cmb_question.get()=="Select" or self.txt_answer.get()=="" or self.txt_password.get()=="" or self.txt_cpassword.get()=="":
            ...
            try:
                ...
                cur=con.cursor()
                cur.execute("insert into register_1 (f_name,l_name,contact,email,question,answer,password) values(%s,%s,%s,%s,%s,%s,%s)",
                            (self.txt_fname.get(),
                             self.txt_lname.get(),
...
root = Tk()
obj = Register(root)
root.iconbitmap(r"C:\Users\user\Desktop\music library\Music album management system\images\favicon.ico")
root.mainloop()